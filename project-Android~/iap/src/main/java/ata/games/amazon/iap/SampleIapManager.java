...
public class SampleIapManager
{
    ...
    final private AmazonPurchaser mainActivity;
    private boolean level2ProductAvailable;
    private UserIapData userIapData;
    final private EntitlementsDataSource dataSource;

    public SampleIapManager(final AmazonPurchaser mainActivity)
    {
        this.mainActivity = mainActivity;
        dataSource = new EntitlementsDataSource(mainActivity.getActivity());
    }
    ...
    public void disablePurchaseForSkus(final Set<String> unavailableSkus)
    {
        if (unavailableSkus.contains(MySku.LEVEL2.toString()))
        {
            ...
            //TODO Replace with toast message mainActivity.showMessage("the level2 product isn't available now! ");
        }
    }
    ...
    {
        ////TODO Replace with toast message  mainActivity.showMessage("Purchase failed!");
    }
    ...
    private void handleEntitlementPurchase(final Receipt receipt, final UserData userData)
    {
        try
        {
            ...
            } else
            {
                ...
                if (!verifyReceiptFromYourService(receipt.getReceiptId(), userData))
                {
                    ...
                    ////TODO Replace with toast message mainActivity.showMessage("Purchase cannot be verified, please retry later.");
                    return;
                }
        ...
        {
            ////TODO Replace with toast message mainActivity.showMessage("Purchase cannot be completed, please retry");
        }
